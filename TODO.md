...
This file tracks next steps for the Todoist CLI work in this folder.

## Backlog

| ID | Created (local) | Updated (local) | Status | Priority | Item | Notes |
|---:|---|---|---|---|---|---|
...
| ID | Created (local) | Updated (local) | Status | Priority | Item | Notes |
|---:|---|---|---|---|---|---|
| 100 | 2026-01-08 00:00 | 2026-01-08 00:00 | Done | P1 | Install tod shim | Added install_tod.ps1 to create a tod.cmd shim that proxies to todoist.exe. |
